...
#include "cpp_ref_impl.directory_settings/io_dir/class_0_0_1_0_the_io.hh"
#include "cpp_ref_impl.directory_settings/hash_dir/class_0_0_0_0_the_hash.hh"
#include "cpp_ref_impl.directory_settings/types_dir/class_0_0_5_0_the_types.hh"
#include "cpp_ref_impl.directory_settings/test_data_dir/class_0_0_4_0_the_test_data.hh"
...
BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    cpp_ref_impl::directory_settings::class_0_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = cpp_ref_impl::directory_settings::class_0();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    cpp_ref_impl::directory_settings::class_0 b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = cpp_ref_impl::directory_settings::class_0();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    cpp_ref_impl::directory_settings::class_0 b = cpp_ref_impl::directory_settings::class_0();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<cpp_ref_impl::directory_settings::class_0> hasher;
