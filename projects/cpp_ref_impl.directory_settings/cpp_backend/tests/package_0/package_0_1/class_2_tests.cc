...
#include "cpp_ref_impl.directory_settings/io_dir/package_0/package_0_1/class_2_0_1_0_the_io.hh"
#include "cpp_ref_impl.directory_settings/serialization_dir/registrar_0_3_7_the_serialization.hh"
#include "cpp_ref_impl.directory_settings/hash_dir/package_0/package_0_1/class_2_0_0_0_the_hash.hh"
#include "cpp_ref_impl.directory_settings/types_dir/package_0/package_0_1/class_2_0_5_0_the_types.hh"
#include "cpp_ref_impl.directory_settings/test_data_dir/package_0/package_0_1/class_2_0_4_0_the_test_data.hh"
#include "cpp_ref_impl.directory_settings/serialization_dir/package_0/package_0_1/class_2_0_3_0_the_serialization.hh"

BOOST_AUTO_TEST_SUITE(package_0_package_0_1_class_2_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    cpp_ref_impl::directory_settings::package_0::package_0_1::class_2_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = cpp_ref_impl::directory_settings::package_0::package_0_1::class_2();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    cpp_ref_impl::directory_settings::package_0::package_0_1::class_2 b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = cpp_ref_impl::directory_settings::package_0::package_0_1::class_2();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    cpp_ref_impl::directory_settings::package_0::package_0_1::class_2 b = cpp_ref_impl::directory_settings::package_0::package_0_1::class_2();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<cpp_ref_impl::directory_settings::package_0::package_0_1::class_2> hasher;
