...
move_ctor_descendant::move_ctor_descendant(move_ctor_descendant&& rhs)
    : masd::cpp_ref_impl::cpp_model::move_ctor_base(
        std::forward<masd::cpp_ref_impl::cpp_model::move_ctor_base>(rhs)),
...
void move_ctor_descendant::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"masd::cpp_ref_impl::cpp_model::move_ctor_descendant\"" << ", "
      << "\"__parent_0__\": ";
...
bool move_ctor_descendant::equals(const masd::cpp_ref_impl::cpp_model::move_ctor_base& other) const {
