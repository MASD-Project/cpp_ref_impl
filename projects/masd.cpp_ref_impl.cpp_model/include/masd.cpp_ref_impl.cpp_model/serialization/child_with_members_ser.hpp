 ...
 *
 */
#ifndef MASD_CPP_REF_IMPL_CPP_MODEL_SERIALIZATION_CHILD_WITH_MEMBERS_SER_HPP
#define MASD_CPP_REF_IMPL_CPP_MODEL_SERIALIZATION_CHILD_WITH_MEMBERS_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(masd::cpp_ref_impl::cpp_model::child_with_members)
namespace boost {
