 ...
 *
 */
#ifndef MASD_CPP_REF_IMPL_CPP_MODEL_TYPES_MOVE_CTOR_BASE_HPP
#define MASD_CPP_REF_IMPL_CPP_MODEL_TYPES_MOVE_CTOR_BASE_HPP
...
#include "masd.cpp_ref_impl.cpp_model/serialization/move_ctor_base_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const masd::cpp_ref_impl::cpp_model::move_ctor_base& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, masd::cpp_ref_impl::cpp_model::move_ctor_base& v, unsigned int version);
