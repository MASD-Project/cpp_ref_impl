 ...
 *
 */
#ifndef MASD_CPP_REF_IMPL_CPP_MODEL_TYPES_BASE_WITH_OBJECT_TEMPLATE_HPP
#define MASD_CPP_REF_IMPL_CPP_MODEL_TYPES_BASE_WITH_OBJECT_TEMPLATE_HPP
...
#include <string>
#include <algorithm>
#include "masd.cpp_ref_impl.cpp_model/serialization/base_with_object_template_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const masd::cpp_ref_impl::cpp_model::base_with_object_template& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, masd::cpp_ref_impl::cpp_model::base_with_object_template& v, unsigned int version);
