 ...
 *
 */
#ifndef MASD_CPP_REF_IMPL_CPP_MODEL_TYPES_PARENT_WITH_MEMBERS_HPP
#define MASD_CPP_REF_IMPL_CPP_MODEL_TYPES_PARENT_WITH_MEMBERS_HPP
...
#include <iosfwd>
#include <algorithm>
#include "masd.cpp_ref_impl.cpp_model/serialization/parent_with_members_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const masd::cpp_ref_impl::cpp_model::parent_with_members& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, masd::cpp_ref_impl::cpp_model::parent_with_members& v, unsigned int version);
