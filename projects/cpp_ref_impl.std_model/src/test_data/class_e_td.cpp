...
std::deque<cpp_ref_impl::std_model::class_a> create_std_deque_cpp_ref_impl_std_model_class_a(unsigned int position) {
    std::deque<cpp_ref_impl::std_model::class_a> r;
    for (unsigned int i(0); i < 4; ++i) {
...
std::deque<cpp_ref_impl::std_model::pkg1::class_c> create_std_deque_cpp_ref_impl_std_model_pkg1_class_c(unsigned int position) {
    std::deque<cpp_ref_impl::std_model::pkg1::class_c> r;
    for (unsigned int i(0); i < 4; ++i) {
...
populate(const unsigned int position, result_type& v) {
    ...
    v.prop_1(create_std_deque_cpp_ref_impl_std_model_class_a(position + 1));
    v.prop_2(create_std_deque_cpp_ref_impl_std_model_pkg1_class_c(position + 2));
    v.prop_3(create_std_deque_unsigned_int(position + 3));
    v.prop_4(create_std_deque_cpp_ref_impl_std_model_class_a(position + 4));
