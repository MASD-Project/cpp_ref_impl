...
BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    cpp_ref_impl::boost_model::class_d_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = cpp_ref_impl::boost_model::class_d();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    cpp_ref_impl::boost_model::class_d b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = cpp_ref_impl::boost_model::class_d();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    cpp_ref_impl::boost_model::class_d b = cpp_ref_impl::boost_model::class_d();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<cpp_ref_impl::boost_model::class_d> hasher;
