...
#include "cpp_ref_impl.boost_model/hash/class_g_hash.hpp"
...
BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    cpp_ref_impl::boost_model::class_g_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = cpp_ref_impl::boost_model::class_g();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    cpp_ref_impl::boost_model::class_g b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = cpp_ref_impl::boost_model::class_g();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    {
        xml_oarchive oa(os);
        cpp_ref_impl::boost_model::registrar::register_types<xml_oarchive>(oa);
        oa << BOOST_SERIALIZATION_NVP(a);
    }

    cpp_ref_impl::boost_model::class_g b = cpp_ref_impl::boost_model::class_g();
    std::istringstream is(os.str());
    {
        xml_iarchive ia(is);
        cpp_ref_impl::boost_model::registrar::register_types<xml_iarchive>(ia);
...
BOOST_AUTO_TEST_CASE(text_roundtrip_produces_the_same_entity) {
    ...
    {
        text_oarchive oa(os);
        cpp_ref_impl::boost_model::registrar::register_types<text_oarchive>(oa);
        oa << a;
    }
    ...
    {
        text_iarchive ia(is);
        cpp_ref_impl::boost_model::registrar::register_types<text_iarchive>(ia);
        ia >> b;
    }
...
BOOST_AUTO_TEST_CASE(binary_roundtrip_produces_the_same_entity) {
    ...
    std::ostringstream os;
    {
        ...
        cpp_ref_impl::boost_model::registrar::register_types<binary_oarchive>(oa);
        oa << a;
    }
    ...
    std::istringstream is(os.str());
    {
        ...
        cpp_ref_impl::boost_model::registrar::register_types<binary_iarchive>(ia);
        ia >> b;
    }
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<cpp_ref_impl::boost_model::class_g> hasher;
