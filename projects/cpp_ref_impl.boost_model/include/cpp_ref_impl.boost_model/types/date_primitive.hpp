 ...
 *
 */
#ifndef CPP_REF_IMPL_BOOST_MODEL_TYPES_DATE_PRIMITIVE_HPP
#define CPP_REF_IMPL_BOOST_MODEL_TYPES_DATE_PRIMITIVE_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const cpp_ref_impl::boost_model::date_primitive& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, cpp_ref_impl::boost_model::date_primitive& v, unsigned int version);
...
template<>
inline void swap(
    cpp_ref_impl::boost_model::date_primitive& lhs,
    cpp_ref_impl::boost_model::date_primitive& rhs) {
    lhs.swap(rhs);
}
