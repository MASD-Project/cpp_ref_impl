 ...
 *
 */
#ifndef MASD_CPP_REF_IMPL_OUT_OF_SYNC_TYPES_UNCHANGED_GENERATED_HPP
#define MASD_CPP_REF_IMPL_OUT_OF_SYNC_TYPES_UNCHANGED_GENERATED_HPP
...
#include <algorithm>
#include "masd.cpp_ref_impl.out_of_sync/serialization/unchanged_generated_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const masd::cpp_ref_impl::out_of_sync::unchanged_generated& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, masd::cpp_ref_impl::out_of_sync::unchanged_generated& v, unsigned int version);
...
template<>
inline void swap(
    masd::cpp_ref_impl::out_of_sync::unchanged_generated& lhs,
    masd::cpp_ref_impl::out_of_sync::unchanged_generated& rhs) {
    lhs.swap(rhs);
}
