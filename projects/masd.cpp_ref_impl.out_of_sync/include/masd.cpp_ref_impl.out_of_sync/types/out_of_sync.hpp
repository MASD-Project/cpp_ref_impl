 ...
 *
 */
#ifndef MASD_CPP_REF_IMPL_OUT_OF_SYNC_TYPES_OUT_OF_SYNC_HPP
#define MASD_CPP_REF_IMPL_OUT_OF_SYNC_TYPES_OUT_OF_SYNC_HPP
 ...
 * changed in class changed_generated and delete the class newly_generated.
 */
