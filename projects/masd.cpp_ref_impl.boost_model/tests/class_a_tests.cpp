...
BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    masd::cpp_ref_impl::boost_model::class_a_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = masd::cpp_ref_impl::boost_model::class_a();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    masd::cpp_ref_impl::boost_model::class_a b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = masd::cpp_ref_impl::boost_model::class_a();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    masd::cpp_ref_impl::boost_model::class_a b = masd::cpp_ref_impl::boost_model::class_a();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<masd::cpp_ref_impl::boost_model::class_a> hasher;
