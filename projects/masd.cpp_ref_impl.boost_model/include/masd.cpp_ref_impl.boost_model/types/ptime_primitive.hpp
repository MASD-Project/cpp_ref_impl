 ...
 *
 */
#ifndef MASD_CPP_REF_IMPL_BOOST_MODEL_TYPES_PTIME_PRIMITIVE_HPP
#define MASD_CPP_REF_IMPL_BOOST_MODEL_TYPES_PTIME_PRIMITIVE_HPP
...
#include "masd.cpp_ref_impl.boost_model/serialization/ptime_primitive_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const masd::cpp_ref_impl::boost_model::ptime_primitive& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, masd::cpp_ref_impl::boost_model::ptime_primitive& v, unsigned int version);
...
template<>
inline void swap(
    masd::cpp_ref_impl::boost_model::ptime_primitive& lhs,
    masd::cpp_ref_impl::boost_model::ptime_primitive& rhs) {
    lhs.swap(rhs);
}
