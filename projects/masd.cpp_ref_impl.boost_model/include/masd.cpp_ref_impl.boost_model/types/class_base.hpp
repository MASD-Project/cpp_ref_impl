 ...
 *
 */
#ifndef CPP_REF_IMPL_BOOST_MODEL_TYPES_CLASS_BASE_HPP
#define CPP_REF_IMPL_BOOST_MODEL_TYPES_CLASS_BASE_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const cpp_ref_impl::boost_model::class_base& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, cpp_ref_impl::boost_model::class_base& v, unsigned int version);
