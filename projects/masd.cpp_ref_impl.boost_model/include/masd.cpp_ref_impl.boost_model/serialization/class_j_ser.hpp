 ...
 *
 */
#ifndef MASD_CPP_REF_IMPL_BOOST_MODEL_SERIALIZATION_CLASS_J_SER_HPP
#define MASD_CPP_REF_IMPL_BOOST_MODEL_SERIALIZATION_CLASS_J_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(masd::cpp_ref_impl::boost_model::class_j)
namespace boost {
