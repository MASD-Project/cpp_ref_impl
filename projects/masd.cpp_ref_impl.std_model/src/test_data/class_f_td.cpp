...
#include "cpp_ref_impl/std_model/test_data/class_f_td.hpp"
...
std::unordered_map<cpp_ref_impl::std_model::class_a, cpp_ref_impl::std_model::pkg1::class_c> create_std_unordered_map_cpp_ref_impl_std_model_class_a_cpp_ref_impl_std_model_pkg1_class_c(unsigned int position) {
    std::unordered_map<cpp_ref_impl::std_model::class_a, cpp_ref_impl::std_model::pkg1::class_c> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.insert(std::make_pair(create_cpp_ref_impl_std_model_class_a(position + i), create_cpp_ref_impl_std_model_pkg1_class_c(position + i)));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.prop_1(create_std_unordered_map_std_string_cpp_ref_impl_std_model_class_a(position + 1));
    v.prop_2(create_std_unordered_map_cpp_ref_impl_std_model_class_a_cpp_ref_impl_std_model_pkg1_class_c(position + 2));
}
