...
std::unordered_set<masd::cpp_ref_impl::std_model::class_a> create_std_unordered_set_masd_cpp_ref_impl_std_model_class_a(unsigned int position) {
    std::unordered_set<masd::cpp_ref_impl::std_model::class_a> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.insert(create_masd_cpp_ref_impl_std_model_class_a(position + i));
    }
    return r;
}
...
std::unordered_set<masd::cpp_ref_impl::std_model::pkg1::class_c> create_std_unordered_set_masd_cpp_ref_impl_std_model_pkg1_class_c(unsigned int position) {
    std::unordered_set<masd::cpp_ref_impl::std_model::pkg1::class_c> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.insert(create_masd_cpp_ref_impl_std_model_pkg1_class_c(position + i));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    v.prop_0(create_std_unordered_set_masd_cpp_ref_impl_std_model_class_a(position + 0));
    v.prop_1(create_std_unordered_set_masd_cpp_ref_impl_std_model_pkg1_class_c(position + 1));
}
