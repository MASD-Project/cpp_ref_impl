...
populate(const unsigned int position, result_type& v) {
    ...
    v.prop_2(create_std_vector_masd_cpp_ref_impl_std_model_pkg1_class_c(position + 2));
    v.prop_3(create_std_vector_unsigned_int(position + 3));
    v.prop_4(create_std_vector_masd_cpp_ref_impl_std_model_class_a(position + 4));
