...
const std::vector<masd::cpp_ref_impl::std_model::class_a>& class_b::prop_1() const {
    return prop_1_;
}

std::vector<masd::cpp_ref_impl::std_model::class_a>& class_b::prop_1() {
    return prop_1_;
}

void class_b::prop_1(const std::vector<masd::cpp_ref_impl::std_model::class_a>& v) {
    prop_1_ = v;
}
...
const std::vector<masd::cpp_ref_impl::std_model::pkg1::class_c>& class_b::prop_2() const {
    return prop_2_;
}

std::vector<masd::cpp_ref_impl::std_model::pkg1::class_c>& class_b::prop_2() {
    return prop_2_;
}

void class_b::prop_2(const std::vector<masd::cpp_ref_impl::std_model::pkg1::class_c>& v) {
    prop_2_ = v;
}
...
const std::vector<masd::cpp_ref_impl::std_model::class_a>& class_b::prop_4() const {
    return prop_4_;
}

std::vector<masd::cpp_ref_impl::std_model::class_a>& class_b::prop_4() {
    return prop_4_;
}

void class_b::prop_4(const std::vector<masd::cpp_ref_impl::std_model::class_a>& v) {
    prop_4_ = v;
}
