...
const std::vector<masd::cpp_ref_impl::std_model::class_a>& class_c::prop_1() const {
    return prop_1_;
}

std::vector<masd::cpp_ref_impl::std_model::class_a>& class_c::prop_1() {
    return prop_1_;
}

void class_c::prop_1(const std::vector<masd::cpp_ref_impl::std_model::class_a>& v) {
    prop_1_ = v;
}
