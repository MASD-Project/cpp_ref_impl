...
#include "masd.cpp_ref_impl.enable_facet_types/types/all.hpp"
...
public:
    typedef masd::cpp_ref_impl::enable_facet_types::package1::first_class result_type;
...
using namespace masd::cpp_ref_impl::enable_facet_types;
using namespace masd::cpp_ref_impl::enable_facet_types::package1;
