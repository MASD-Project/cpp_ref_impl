...
#include "masd.cpp_ref_impl.utility/test/macros.hpp"
#include "masd.cpp_ref_impl.utility/test/canned_tests.hpp"
#include "masd.cpp_ref_impl.enable_facet_serialization/serialization/all_ser.hpp"
#include "masd.cpp_ref_impl.enable_facet_serialization/types/all.hpp"
...
public:
    typedef masd::cpp_ref_impl::enable_facet_serialization::package1::first_class result_type;
...
using namespace masd::cpp_ref_impl::enable_facet_serialization;
using namespace masd::cpp_ref_impl::enable_facet_serialization::package1;
