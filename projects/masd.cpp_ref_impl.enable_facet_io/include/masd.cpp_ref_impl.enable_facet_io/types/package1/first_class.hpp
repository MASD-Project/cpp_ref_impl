 ...
 *
 */
#ifndef MASD_CPP_REF_IMPL_ENABLE_FACET_IO_TYPES_PACKAGE1_FIRST_CLASS_HPP
#define MASD_CPP_REF_IMPL_ENABLE_FACET_IO_TYPES_PACKAGE1_FIRST_CLASS_HPP
...
template<>
inline void swap(
    masd::cpp_ref_impl::enable_facet_io::package1::first_class& lhs,
    masd::cpp_ref_impl::enable_facet_io::package1::first_class& rhs) {
    lhs.swap(rhs);
}
