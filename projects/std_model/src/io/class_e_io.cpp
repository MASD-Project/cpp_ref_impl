...
inline std::ostream& operator<<(std::ostream& s, const std::deque<std::string>& v) {
    s << "[ ";
...
inline std::ostream& operator<<(std::ostream& s, const std::deque<unsigned int>& v) {
    s << "[ ";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << *i;
...
inline std::ostream& operator<<(std::ostream& s, const std::deque<std::deque<unsigned int> >& v) {
    s << "[ ";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << *i;
