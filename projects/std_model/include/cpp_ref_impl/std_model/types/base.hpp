 ...
 *
 */
#ifndef CPP_REF_IMPL_STD_MODEL_TYPES_BASE_HPP
#define CPP_REF_IMPL_STD_MODEL_TYPES_BASE_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const cpp_ref_impl::std_model::base& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, cpp_ref_impl::std_model::base& v, unsigned int version);
