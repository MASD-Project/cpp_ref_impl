 ...
 *
 */
#ifndef CPP_REF_IMPL_STD_MODEL_TYPES_BUILTINS_HPP
#define CPP_REF_IMPL_STD_MODEL_TYPES_BUILTINS_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const cpp_ref_impl::std_model::builtins& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, cpp_ref_impl::std_model::builtins& v, unsigned int version);
...
template<>
inline void swap(
    cpp_ref_impl::std_model::builtins& lhs,
    cpp_ref_impl::std_model::builtins& rhs) {
    lhs.swap(rhs);
}
