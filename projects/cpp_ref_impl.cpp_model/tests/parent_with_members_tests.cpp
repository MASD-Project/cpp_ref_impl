...
BOOST_AUTO_TEST_SUITE(parent_with_members_tests)

BOOST_AUTO_TEST_CASE(inserter_operator_produces_valid_json) {
    cpp_ref_impl::cpp_model::parent_with_members_generator g;
    const boost::shared_ptr<cpp_ref_impl::cpp_model::parent_with_members> a(g.create_ptr(1));
    std::stringstream s;
    s << *a;
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    boost::shared_ptr<cpp_ref_impl::cpp_model::parent_with_members> b;
