 ...
 *
 */
#ifndef CPP_REF_IMPL_CPP_MODEL_TYPES_BASE_WITH_OBJECT_TEMPLATE_HPP
#define CPP_REF_IMPL_CPP_MODEL_TYPES_BASE_WITH_OBJECT_TEMPLATE_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const cpp_ref_impl::cpp_model::base_with_object_template& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, cpp_ref_impl::cpp_model::base_with_object_template& v, unsigned int version);
