 ...
 *
 */
#ifndef CPP_REF_IMPL_CPP_MODEL_TYPES_PARENT_WITHOUT_MEMBERS_HPP
#define CPP_REF_IMPL_CPP_MODEL_TYPES_PARENT_WITHOUT_MEMBERS_HPP
...
#include <iosfwd>
#include <algorithm>
#include "cpp_ref_impl.cpp_model/serialization/parent_without_members_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const cpp_ref_impl::cpp_model::parent_without_members& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, cpp_ref_impl::cpp_model::parent_without_members& v, unsigned int version);
