 ...
 *
 */
#ifndef CPP_REF_IMPL_CPP_MODEL_TYPES_CHILD_VIA_SETTINGS_HPP
#define CPP_REF_IMPL_CPP_MODEL_TYPES_CHILD_VIA_SETTINGS_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const cpp_ref_impl::cpp_model::child_via_settings& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, cpp_ref_impl::cpp_model::child_via_settings& v, unsigned int version);
...
template<>
inline void swap(
    cpp_ref_impl::cpp_model::child_via_settings& lhs,
    cpp_ref_impl::cpp_model::child_via_settings& rhs) {
    lhs.swap(rhs);
}
