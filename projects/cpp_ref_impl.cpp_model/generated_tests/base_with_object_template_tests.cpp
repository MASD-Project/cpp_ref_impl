...
BOOST_AUTO_TEST_SUITE(base_with_object_template_tests)

BOOST_AUTO_TEST_CASE(inserter_operator_produces_valid_json) {
    cpp_ref_impl::cpp_model::base_with_object_template_generator g;
    const boost::shared_ptr<cpp_ref_impl::cpp_model::base_with_object_template> a(g.create_ptr(1));
    std::stringstream s;
    s << *a;
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    boost::shared_ptr<cpp_ref_impl::cpp_model::base_with_object_template> b;
