...
BOOST_AUTO_TEST_SUITE(move_ctor_base_tests)

BOOST_AUTO_TEST_CASE(inserter_operator_produces_valid_json) {
    cpp_ref_impl::cpp_model::move_ctor_base_generator g;
    const boost::shared_ptr<cpp_ref_impl::cpp_model::move_ctor_base> a(g.create_ptr(1));
    std::stringstream s;
    s << *a;
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    boost::shared_ptr<cpp_ref_impl::cpp_model::move_ctor_base> b;
