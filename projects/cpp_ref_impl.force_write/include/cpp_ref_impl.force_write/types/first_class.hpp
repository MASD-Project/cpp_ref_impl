 ...
 *
 */
#ifndef CPP_REF_IMPL_FORCE_WRITE_TYPES_FIRST_CLASS_HPP
#define CPP_REF_IMPL_FORCE_WRITE_TYPES_FIRST_CLASS_HPP
...
namespace cpp_ref_impl::force_write {
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const cpp_ref_impl::force_write::first_class& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, cpp_ref_impl::force_write::first_class& v, unsigned int version);
...
template<>
inline void swap(
    cpp_ref_impl::force_write::first_class& lhs,
    cpp_ref_impl::force_write::first_class& rhs) {
    lhs.swap(rhs);
}
