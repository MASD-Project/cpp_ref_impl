 ...
 *
 */
#ifndef MASD_CPP_REF_IMPL_ENABLE_FACET_TYPES_TYPES_PACKAGE1_FIRST_CLASS_HPP
#define MASD_CPP_REF_IMPL_ENABLE_FACET_TYPES_TYPES_PACKAGE1_FIRST_CLASS_HPP
...
namespace masd::cpp_ref_impl::enable_facet_types::package1 {
...
template<>
inline void swap(
    masd::cpp_ref_impl::enable_facet_types::package1::first_class& lhs,
    masd::cpp_ref_impl::enable_facet_types::package1::first_class& rhs) {
    lhs.swap(rhs);
}
