 ...
 *
 */
#ifndef CPP_REF_IMPL_OUT_OF_SYNC_TYPES_CHANGED_GENERATED_HPP
#define CPP_REF_IMPL_OUT_OF_SYNC_TYPES_CHANGED_GENERATED_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const cpp_ref_impl::out_of_sync::changed_generated& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, cpp_ref_impl::out_of_sync::changed_generated& v, unsigned int version);
...
template<>
inline void swap(
    cpp_ref_impl::out_of_sync::changed_generated& lhs,
    cpp_ref_impl::out_of_sync::changed_generated& rhs) {
    lhs.swap(rhs);
}
