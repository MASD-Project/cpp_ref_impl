...
#include "cpp_ref_impl.out_of_sync/io/changed_generated_io.hpp"
#include "cpp_ref_impl.out_of_sync/types/changed_generated.hpp"
#include "cpp_ref_impl.out_of_sync/hash/changed_generated_hash.hpp"
#include "cpp_ref_impl.out_of_sync/serialization/registrar_ser.hpp"
#include "cpp_ref_impl.out_of_sync/test_data/changed_generated_td.hpp"
#include "cpp_ref_impl.out_of_sync/serialization/changed_generated_ser.hpp"

BOOST_AUTO_TEST_SUITE(changed_generated_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    cpp_ref_impl::out_of_sync::changed_generated_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = cpp_ref_impl::out_of_sync::changed_generated();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    cpp_ref_impl::out_of_sync::changed_generated b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = cpp_ref_impl::out_of_sync::changed_generated();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    cpp_ref_impl::out_of_sync::changed_generated b = cpp_ref_impl::out_of_sync::changed_generated();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<cpp_ref_impl::out_of_sync::changed_generated> hasher;
