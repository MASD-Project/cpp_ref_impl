 ...
 *
 */
#ifndef MASD_CPP_REF_IMPL_LAM_MODEL_TYPES_BUILTINS_HPP
#define MASD_CPP_REF_IMPL_LAM_MODEL_TYPES_BUILTINS_HPP
...
#include <cstdint>
#include <algorithm>
#include "masd.cpp_ref_impl.lam_model/serialization/builtins_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const masd::cpp_ref_impl::lam_model::builtins& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, masd::cpp_ref_impl::lam_model::builtins& v, unsigned int version);
...
template<>
inline void swap(
    masd::cpp_ref_impl::lam_model::builtins& lhs,
    masd::cpp_ref_impl::lam_model::builtins& rhs) {
    lhs.swap(rhs);
}
