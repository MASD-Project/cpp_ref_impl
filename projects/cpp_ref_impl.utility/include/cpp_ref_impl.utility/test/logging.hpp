 ...
 *
 */
#ifndef CPP_REF_IMPL_UTILITY_TEST_LOGGING_HPP
#define CPP_REF_IMPL_UTILITY_TEST_LOGGING_HPP
...
namespace cpp_ref_impl::utility::test {

void log_if_test_has_failed();

cpp_ref_impl::utility::log::scoped_life_cycle_manager
...
#define SETUP_TEST_LOG(function_name)                                             \
    ...
    auto sl(cpp_ref_impl::utility::test::scoped_life_cycle_manager_factory( \
            test_module, test_suite, function_name));                             \
    const auto pd(cpp_ref_impl::utility::test::probing_directory_path(      \
            test_module, test_suite, function_name));
...
#define SETUP_TEST_LOG_SOURCE(function_name)                                      \
    BOOST_TEST_CHECKPOINT(function_name);                                         \
    cpp_ref_impl::utility::log::logger lg(                                  \
        cpp_ref_impl::utility::log::logger_factory(test_suite));            \
