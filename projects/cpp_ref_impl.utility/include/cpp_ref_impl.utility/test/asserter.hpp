...
private:
    static cpp_ref_impl::utility::log::logger lg_;

public:
    static cpp_ref_impl::utility::log::logger logger() { return lg_; }
...
public:
    ...
    static bool assert_object(
        ...
        using cpp_ref_impl::utility::test::xml_serialize;
        using namespace cpp_ref_impl::utility::log;
        ...
        using cpp_ref_impl::utility::test::xml_deserialize;
        using namespace cpp_ref_impl::utility::log;
