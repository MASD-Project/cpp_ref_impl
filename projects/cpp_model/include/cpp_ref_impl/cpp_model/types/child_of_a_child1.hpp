 ...
 *
 */
#ifndef CPP_REF_IMPL_CPP_MODEL_TYPES_CHILD_OF_A_CHILD1_HPP
#define CPP_REF_IMPL_CPP_MODEL_TYPES_CHILD_OF_A_CHILD1_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const cpp_ref_impl::cpp_model::child_of_a_child1& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, cpp_ref_impl::cpp_model::child_of_a_child1& v, unsigned int version);
...
template<>
inline void swap(
    cpp_ref_impl::cpp_model::child_of_a_child1& lhs,
    cpp_ref_impl::cpp_model::child_of_a_child1& rhs) {
    lhs.swap(rhs);
}
