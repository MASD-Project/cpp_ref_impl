 ...
 *
 */
#ifndef CPP_REF_IMPL_CPP_MODEL_TYPES_SECOND_DESCENDANT_OBJECT_TEMPLATE_INSTANCE_HPP
#define CPP_REF_IMPL_CPP_MODEL_TYPES_SECOND_DESCENDANT_OBJECT_TEMPLATE_INSTANCE_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const cpp_ref_impl::cpp_model::second_descendant_object_template_instance& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, cpp_ref_impl::cpp_model::second_descendant_object_template_instance& v, unsigned int version);
...
template<>
inline void swap(
    cpp_ref_impl::cpp_model::second_descendant_object_template_instance& lhs,
    cpp_ref_impl::cpp_model::second_descendant_object_template_instance& rhs) {
    lhs.swap(rhs);
}
