...
#include "masd.cpp_ref_impl.northwind/odb/customers-odb-sqlite.hxx"
...
namespace odb
{
  ...
  struct access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::id_type
  access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::
  ...
  bool access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::
  grow (image_type& i,
        bool* t)
  {
  ...
  void access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::
  bind (sqlite::bind* b,
        image_type& i,
  ...
  const char access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::find_statement[] =
  "SELECT "
  ...
  const char access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::update_statement[] =
  ...
  const char access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::erase_statement[] =
  "DELETE FROM \"NORTHWIND\".\"CUSTOMERS\" "
  "WHERE \"CUSTOMER_ID\"=?";

  const char access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::query_statement[] =
  "SELECT "
  "\"NORTHWIND\".\"CUSTOMERS\".\"CUSTOMER_ID\", "
  "\"NORTHWIND\".\"CUSTOMERS\".\"CUSTOMER_CODE\", "
  "\"NORTHWIND\".\"CUSTOMERS\".\"COMPANY_NAME\", "
  ...
  const char access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::erase_query_statement[] =
  "DELETE FROM \"NORTHWIND\".\"CUSTOMERS\"";

  const char access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::table_name[] =
  "\"NORTHWIND\".\"CUSTOMERS\"";
  ...
  access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::pointer_type
  access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::
  ...
  result< access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::object_type >
  access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::
  ...
  unsigned long long access::object_traits_impl< ::masd::cpp_ref_impl::northwind::customers, id_sqlite >::
