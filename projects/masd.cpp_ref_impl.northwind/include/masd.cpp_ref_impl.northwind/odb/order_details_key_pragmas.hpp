 ...
 *
 */
#ifndef MASD_CPP_REF_IMPL_NORTHWIND_ODB_ORDER_DETAILS_KEY_PRAGMAS_HPP
#define MASD_CPP_REF_IMPL_NORTHWIND_ODB_ORDER_DETAILS_KEY_PRAGMAS_HPP
...
#pragma db value(order_details_key) schema("NORTHWIND")
