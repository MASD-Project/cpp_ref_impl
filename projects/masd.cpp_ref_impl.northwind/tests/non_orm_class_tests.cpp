...
#include "masd.cpp_ref_impl.northwind/types/non_orm_class.hpp"
#include "masd.cpp_ref_impl.northwind/test_data/non_orm_class_td.hpp"
#include "masd.cpp_ref_impl.northwind/serialization/registrar_ser.hpp"
#include "masd.cpp_ref_impl.northwind/serialization/non_orm_class_ser.hpp"

BOOST_AUTO_TEST_SUITE(non_orm_class_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    masd::cpp_ref_impl::northwind::non_orm_class_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = masd::cpp_ref_impl::northwind::non_orm_class();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    masd::cpp_ref_impl::northwind::non_orm_class b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = masd::cpp_ref_impl::northwind::non_orm_class();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    {
        xml_oarchive oa(os);
        masd::cpp_ref_impl::northwind::register_types<xml_oarchive>(oa);
        oa << BOOST_SERIALIZATION_NVP(a);
    }

    masd::cpp_ref_impl::northwind::non_orm_class b = masd::cpp_ref_impl::northwind::non_orm_class();
    std::istringstream is(os.str());
    {
        xml_iarchive ia(is);
        masd::cpp_ref_impl::northwind::register_types<xml_iarchive>(ia);
...
BOOST_AUTO_TEST_CASE(text_roundtrip_produces_the_same_entity) {
    ...
    {
        text_oarchive oa(os);
        masd::cpp_ref_impl::northwind::register_types<text_oarchive>(oa);
        oa << a;
    }
    ...
    {
        text_iarchive ia(is);
        masd::cpp_ref_impl::northwind::register_types<text_iarchive>(ia);
        ia >> b;
    }
...
BOOST_AUTO_TEST_CASE(binary_roundtrip_produces_the_same_entity) {
    ...
    std::ostringstream os;
    {
        ...
        masd::cpp_ref_impl::northwind::register_types<binary_oarchive>(oa);
        oa << a;
    }
    ...
    std::istringstream is(os.str());
    {
        ...
        masd::cpp_ref_impl::northwind::register_types<binary_iarchive>(ia);
        ia >> b;
    }
