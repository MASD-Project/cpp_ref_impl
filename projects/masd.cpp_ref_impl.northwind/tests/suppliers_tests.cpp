...
#include "masd.cpp_ref_impl.northwind/io/suppliers_io.hpp"
...
BOOST_AUTO_TEST_SUITE(suppliers_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    masd::cpp_ref_impl::northwind::suppliers_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = masd::cpp_ref_impl::northwind::suppliers();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    masd::cpp_ref_impl::northwind::suppliers b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = masd::cpp_ref_impl::northwind::suppliers();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    masd::cpp_ref_impl::northwind::suppliers b = masd::cpp_ref_impl::northwind::suppliers();
