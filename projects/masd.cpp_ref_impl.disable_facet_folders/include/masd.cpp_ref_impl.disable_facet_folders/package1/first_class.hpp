 ...
 *
 */
#ifndef CPP_REF_IMPL_DISABLE_FACET_FOLDERS_PACKAGE1_FIRST_CLASS_HPP
#define CPP_REF_IMPL_DISABLE_FACET_FOLDERS_PACKAGE1_FIRST_CLASS_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const cpp_ref_impl::disable_facet_folders::package1::first_class& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, cpp_ref_impl::disable_facet_folders::package1::first_class& v, unsigned int version);
...
template<>
inline void swap(
    cpp_ref_impl::disable_facet_folders::package1::first_class& lhs,
    cpp_ref_impl::disable_facet_folders::package1::first_class& rhs) {
    lhs.swap(rhs);
}
