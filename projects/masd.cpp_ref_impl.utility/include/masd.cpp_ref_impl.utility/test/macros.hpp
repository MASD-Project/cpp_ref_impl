 ...
 *
 */
#ifndef CPP_REF_IMPL_UTILITY_TEST_MACROS_HPP
#define CPP_REF_IMPL_UTILITY_TEST_MACROS_HPP
...
#ifdef CPP_REF_IMPL_TEST_COMPILATION
#define CPP_REF_IMPL_COMPILE_BROKEN_CODE
#else
#undef CPP_REF_IMPL_COMPILE_BROKEN_CODE
#endif
