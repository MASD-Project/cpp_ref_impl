...
BOOST_AUTO_TEST_SUITE(child_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    cpp_ref_impl::cpp_98::child_generator g;
    const cpp_ref_impl::cpp_98::child a(g());
    const cpp_ref_impl::cpp_98::child b(a);
...
BOOST_AUTO_TEST_CASE(distinct_objects_are_unequal) {
    cpp_ref_impl::cpp_98::child_generator g;
    const cpp_ref_impl::cpp_98::child a(g());
    const cpp_ref_impl::cpp_98::child b(g());
...
#endif
    cpp_ref_impl::cpp_98::child_generator g;
    cpp_ref_impl::cpp_98::child a(g());
    const cpp_ref_impl::cpp_98::child b(a);
    const cpp_ref_impl::cpp_98::child c(g());
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    g();
    const cpp_ref_impl::cpp_98::child a(g());
    cpp_ref_impl::cpp_98::child b(a);
    BOOST_CHECK(a == b);

    b = cpp_ref_impl::cpp_98::child();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(swapping_objects_results_in_the_expected_state) {
    ...
    cpp_ref_impl::cpp_98::child c(a);
    cpp_ref_impl::cpp_98::child d(b);
    BOOST_CHECK(c == a);
    BOOST_CHECK(d == b);
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    {
        xml_oarchive oa(os);
        cpp_ref_impl::cpp_98::new_registrar::register_types<xml_oarchive>(oa);
        oa << BOOST_SERIALIZATION_NVP(a);
    }

    cpp_ref_impl::cpp_98::child b = cpp_ref_impl::cpp_98::child();
    std::istringstream is(os.str());
    {
        xml_iarchive ia(is);
        cpp_ref_impl::cpp_98::new_registrar::register_types<xml_iarchive>(ia);
...
BOOST_AUTO_TEST_CASE(text_roundtrip_produces_the_same_entity) {
    ...
    {
        text_oarchive oa(os);
        cpp_ref_impl::cpp_98::new_registrar::register_types<text_oarchive>(oa);
        oa << a;
    }
    ...
    {
        text_iarchive ia(is);
        cpp_ref_impl::cpp_98::new_registrar::register_types<text_iarchive>(ia);
        ia >> b;
    }
...
BOOST_AUTO_TEST_CASE(binary_roundtrip_produces_the_same_entity) {
    ...
    std::ostringstream os;
    {
        ...
        cpp_ref_impl::cpp_98::new_registrar::register_types<binary_oarchive>(oa);
        oa << a;
    }
    ...
    std::istringstream is(os.str());
    {
        ...
        cpp_ref_impl::cpp_98::new_registrar::register_types<binary_iarchive>(ia);
        ia >> b;
    }
