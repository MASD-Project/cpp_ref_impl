...
BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    masd::cpp_ref_impl::cpp_98::package1::first_class_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = masd::cpp_ref_impl::cpp_98::package1::first_class();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    masd::cpp_ref_impl::cpp_98::package1::first_class b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = masd::cpp_ref_impl::cpp_98::package1::first_class();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    masd::cpp_ref_impl::cpp_98::package1::first_class b = masd::cpp_ref_impl::cpp_98::package1::first_class();
