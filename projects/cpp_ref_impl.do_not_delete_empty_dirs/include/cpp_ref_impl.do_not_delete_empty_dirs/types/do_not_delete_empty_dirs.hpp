 ...
 *
 */
#ifndef CPP_REF_IMPL_DO_NOT_DELETE_EMPTY_DIRS_TYPES_DO_NOT_DELETE_EMPTY_DIRS_HPP
#define CPP_REF_IMPL_DO_NOT_DELETE_EMPTY_DIRS_TYPES_DO_NOT_DELETE_EMPTY_DIRS_HPP
